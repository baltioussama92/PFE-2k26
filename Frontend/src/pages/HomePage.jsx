          ...
          >
            {TESTIMONIALS.map(({ text, name, role, avatar, stars }) => (
              <motion.div
                ...
                variants={cardVar}
                whileHover={{ y: -4 }}
                className="bg-white rounded-2xl p-6 shadow-glass border border-slate-100"
              >
                ...
                <p className="text-sm text-slate-700 leading-relaxed italic mb-5">"{text}"</p>
                <div className="flex items-center gap-3">
                  <img src={avatar} alt={name} className="w-9 h-9 rounded-full object-cover ring-2 ring-primary-100" />
                  <div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary-600 to-primary-800
                       px-8 py-14 text-center text-white shadow-glass-lg"
          >
            {/* Decorative orbs */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3" />
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-emerald-400/20 rounded-full blur-3xl -translate-x-1/4 translate-y-1/4" />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.button
                  ...
                  className="flex items-center gap-2 px-8 py-3.5 rounded-xl
                             bg-white text-primary-700 font-bold text-sm shadow-lg
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 px-8 py-3.5 rounded-xl
                             border-2 border-white/40 text-white font-semibold text-sm
