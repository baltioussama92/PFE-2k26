...
export default function PropertyGrid({ title = 'Propriétés en vedette', searchResult = null }) {
  ...
  const source   = searchResult ?? PROPERTIES
        ...
        >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none input-field pr-8 py-2 text-xs cursor-pointer"
            >
          ...
          <div className="flex items-center border border-slate-200 rounded-xl overflow-hidden">
            <button
              ...
              className={`p-2 transition-colors duration-150 ${
                layout === 'grid' ? 'bg-primary-50 text-primary-600' : 'text-slate-400 hover:bg-slate-50'
              }`}
            >
            ...
            <button
              ...
              className={`p-2 transition-colors duration-150 ${
                layout === 'list' ? 'bg-primary-50 text-primary-600' : 'text-slate-400 hover:bg-slate-50'
              }`}
            >
