...
export default function Navbar({ user = null, onAuthClick }) {
    ...
    <>
      ...
      <motion.header
        ...
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
          scrolled
            ? 'py-2.5 bg-white/80 backdrop-blur-xl shadow-glass border-b border-white/40'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0 group">
            <motion.div
              ...
              className="w-9 h-9 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl
          ...
          <div className="flex items-center gap-2">
            ...
            {user && (
              <motion.button
                ...
                whileTap={{ scale: 0.93 }}
                className="relative p-2 rounded-xl text-slate-500 hover:text-primary-600 hover:bg-primary-50
                           transition-colors duration-150"
              >
            ...
            {user ? (
                ...
                <AnimatePresence>
                  {dropdownOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 top-full mt-2 w-52 glass rounded-2xl
                                 overflow-hidden shadow-glass-lg py-1"
                    >
              ...
              <div className="hidden sm:flex items-center gap-2">
                <motion.button
                  ...
                  className="px-5 py-2 rounded-xl text-sm font-semibold text-slate-700
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-50 w-72 glass-dark
                         flex flex-col pt-20 pb-8 px-5 gap-2 md:hidden"
            >
              {NAV_LINKS.map(({ to, label, icon: Icon }) => (
                <Link
                  key={to}
